...
class IssuesController < ApplicationController
  ...
  def stats_by_neighborhood
    @stats=get_stats(:neighborhood,params[:days_back].to_i)
  end

  def stats_by_request_type
    @stats=get_stats(:rtt,params[:days_back].to_i)
  end

  def stats_by_request_type_and_neighborhood
    @request_type=params[:request_type]
    @stats=get_stats(:both,params[:days_back].to_i,request_type=params[:request_type])
  end

  ## construct parameters using get_stats
  ## and execute query using query_issues

  def query_issues(parameters)
    issues=Issue.where(parameters)
  ...
  def get_stats(param,days_back=nil,request_type=nil)
    stats=[]
